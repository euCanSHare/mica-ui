<#macro rightmenus>
  ...
  <#elseif config??>
    ...
    <#if !config.openAccess || config.dataAccessEnabled>
      <li>
        <a class="nav-link" href="https://dev-agate.eucanshare.bsc.es/auth/signin/eush-dev?redirect=https%3A%2F%2Fdev-mica.eucanshare.bsc.es/admin&signin_error=https%3A%2F%2Fdev-mica.eucanshare.bsc.es%2Fsignup-with"><@message "Cohorts Mgt."/></a>
      </li>
      <li class="nav-item">
